...
<body>
            ...
            <div class="content__header">
                ...
                <div class="card__head">
                    <div class="card" id="popup_card">
                        <img src="uploads/Group 16.png" alt="">
                        <span>2</span>
                    </div>
                </div>
            </div>
    ...
    <!-- <section class="slide__body">
        <div class="container">
            <div class="container_slide">
                <div class="slides">
                    <div class="item">
                        <img src="uploads/Rectangle 3.png" alt="">
                    </div>
                    <div class="item">
                        <img src="uploads/Rectangle 3.png" alt="">
                    </div>
    ...
    <section class="body_product">
        <div class="container">
            <div class="title"><h3><i>Sản phẩm Tồn Kho</i></h3></div>
            <div class="show_product">
                <div class="card">
                    <div class="items">
                        <div class="image">
                            <img src="img/taynghe10.jpg" alt="">
                        </div>
                        <div class="text">
                            <h3>Áo đẹp </h3>
                            <p>200.000 đ</p>
    ...
    <!-- end Body product one -->
     ...
     <section class="body_product discount">
        <div class="container">
            <div class="title"><h3>Sản Phẩm Bán Chạy Nhất Thị Trường</h3></div>
            <div class="show_product">
                <div class="card">
                    <div class="items">
                        <div class="image">
                            <img src="img/taynghe01.jpg" alt="">
                        </div>
                        <div class="text">
                            <h3>Áo đẹp </h3>
    ...
    <div class="container">
			<div class="row">
				...
				<div class="col-4">
					...
					<ul>
						<i>
						<li><a href="mailto:Ngkduy2003@gmail.com">Liên hệ: Ngkduy2003@gmail.com</a></li>
